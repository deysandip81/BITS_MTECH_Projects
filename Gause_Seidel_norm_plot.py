...
for i in range(0, 25):
    ...
    xdiff =[]
    xdiff =[(xnew[0] - xold[0]),(xnew[1] - xold[1]),(xnew[2] - xold[2]),(xnew[3] - xold[3])]
    print("The xdiff vector is ::"+str(xdiff))
    print("The Frobenius norms of the matrix is ::"+str(LA.norm(xdiff))+".\n")
